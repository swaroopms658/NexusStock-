...
export default function Dashboard() {
  ...
  // Handle Selling Stock (Stock-Out)
  const handleSell = async (sku) => {
    ...
    if (res.ok) {
      fetchData(); // Refresh immediately to show new stock level
    }
  };
